...
# Repository hygiene: no developer-specific build paths or generated state.
! grep -R -nE --exclude=test-source-contracts.sh '/home/(paul|[^/[:space:]]+)/atlantian|grey-subdevice|Crate' scripts config .gitignore README.md docs
